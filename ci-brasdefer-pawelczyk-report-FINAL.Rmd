...
They beging this framework by establishing some precision around the idea of the 'event' and how it relates to the total number of children that an individual will have over their lifetime. The authors assign a variable that corresponds to the number of children 'k' for individual _i_. This _ki_, is named the "anticipated lifetime fertility path" (ALFP) for one person, and is a set of values beginning with 0 and ending with the total number _kiT_ at the end of a person's life _'T'_, where the value of _kit_ at any point _t_ is the number of children of the individual at that time.
